...
public class UserNameJsfValidator implements Validator,Serializable{
		      ...
		      .get("currentEntity");
		       ...
		       boolean isValid = false;
		        ...
		        try {
		            ...
		            cr.add(Restrictions.eq("userName", value.toString().trim()));
		            ...
		            if (count == 0) {
		                 ...
		                 FacesMessage msg = new FacesMessage("username does not exists ", uniqueColumn);
